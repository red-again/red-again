...
Offensive security engineer focused on cloud-native, Kubernetes, AI infrastructure, and Windows malware research. I build tools to automate cloud attack path validation and analyze systems-level components.
